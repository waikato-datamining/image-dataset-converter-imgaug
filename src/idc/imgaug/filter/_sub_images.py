...
class SubImages(Filter):
    ...
    def initialize(self):
        ...
        if ((self.regions is None) or (len(self.regions) == 0)) and (self.num_rows is None) and (self.num_cols is None):
            raise Exception("Neither region definitions nor num rows/cols supplied!")
