...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(
        description="Tool for combining image regions generated by the 'sub-images' filter.",
        prog=COMBINE_SUB_IMAGES,
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("-i", "--input", type=str, help="Path to the report file(s) to read; glob syntax is supported", required=True, nargs="+")
